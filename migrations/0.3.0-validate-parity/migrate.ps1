<#
    .SYNOPSIS
    0.3.0-validate-parity: bridge stub — placeholder until phase decomposition lands.

    .DESCRIPTION
    Placeholder body that returns Skipped=$true to advance the schema pointer
    without invoking the placeholder for Phase 2 (validate-parity) phase code. The corresponding
...
function Get-MigrationPreview {
    ...
    return [PSCustomObject]@{
        Migration            = '0.3.0-validate-parity'
