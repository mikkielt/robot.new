<#
    .SYNOPSIS
    0.8.0-enroll-currency-csv: bridge stub — placeholder until phase decomposition lands.

    .DESCRIPTION
    Placeholder body that returns Skipped=$true to advance the schema pointer
    without invoking the placeholder for Phase 7 (currency enrollment) phase code. The corresponding
...
function Get-MigrationPreview {
    ...
    return [PSCustomObject]@{
        Migration            = '0.8.0-enroll-currency-csv'
